...
var name = 'garfield';
var result = index_1.patternMatch(name, index_1.with_('garfield', function (matchedName) { return matchedName + " is a cat"; }), index_1.with_('odie', function (matchedName) { return matchedName + " is a cat"; }));
